...
<?php
	...
	$query = "SELECT @rank:=@rank+1 as rank, truncate(sum(i.Sales),2) from cigar.invoice I inner join cigar.invoice_detail i on I.InvoiceNumber=i.InvoiceNumber group by I.InvoiceDate";
	$title = "Time series";
