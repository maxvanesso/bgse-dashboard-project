...
<?php
	...
	$query = "SELECT month(I.InvoiceDate), truncate(sum(i.Sales),2) as Total from cigar.invoice I inner join cigar.invoice_detail i on I.InvoiceNumber=i.InvoiceNumber group by month(I.InvoiceDate)";
	$title = "Time series";
