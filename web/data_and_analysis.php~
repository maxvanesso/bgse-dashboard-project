...
<?php
	...
	$query = "SELECT date_format(I.InvoiceDate, '%y%j'), truncate(i.Sales,2) as Sales from cigar.invoice I inner join cigar.invoice_detail i on I.InvoiceNumber=i.InvoiceNumber group by I.InvoiceDate";
	$title = "Time series";
